...
Текстовое поле для названия страны (например, ``Russia'', ``Gabon''). 

Числовое поле для указания номера полоски цвета, считаем сверху вниз, отсчёт начинаем с единицы.

Числовое? поле для указания RGB-цвета.

Текстовое поле для названия цвета. Комментарий с названием цвета для RGB-кода.
