...
\begin{task}
    ...
    \newthought{В данном алгоритме можно использовать любое действительное число. Например: -1; 1 ; 2; 22/6 и другие. Чтобы получить число сотен в числе, необходимо от полученного в результате выполнения шагов алгоритма числа отнять 250 и разделить его на 100.} ... todo. 
    \small{Вопрос на с..  todo}
\end{task}

\begin{task}
    \label{answer:naming}
    \newthought{Ответ такой} 
    Самые популярные стили написания составных слов: Camel case, Snake case, Kebab case, Pascal case, Upper case (в сочетании со snake case). 
\end{task}
