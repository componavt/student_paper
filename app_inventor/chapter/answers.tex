...
\begin{task}
    ...
    \newthought{В данном алгоритме можно использовать любое рациональное число}. Например: -1; 1 ; 2; 22/6 и другие. 
    \small{Вопрос на с.~\pageref{question:text}}
\end{task}

\begin{task}
    \label{answer:naming}
    \newthought{Существуют следующие стили написания составных слов}: CamelCase, SnakeCase, KebabCase, PascalCase и другие. 
