...
%    \index{Переменная / Variable!Global / Глобальная}
%    \index{Переменная\_Глобальная}
...
}\marginnote[0.2cm]{Чем хороши глобальные переменные и какие у них недостатки
...
\begin{figure}
  \includegraphics{./graphics/programs/change_flags/proc_swap_colors_2018.png}
    \caption[Процедура \var{swapColors}.][46pt]{Процедура \var{swapColors}.
